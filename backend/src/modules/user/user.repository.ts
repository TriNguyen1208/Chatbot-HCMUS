...
import { type User, type UserDB } from "./user.entity.js";
import { Types } from "mongoose";
import { getUserRoleFromStudentID } from "./user.hcmus.js";
...
export class UserRepository implements IUserRepository {
    ...
    private mapToDomain(doc: UserDB | null): User | null {
        ...
        const role = rest.role || (rest.student_id ? getUserRoleFromStudentID(rest.student_id) : "Khách");
        return {
            id: _id?.toString(),
            ...rest,
            role
