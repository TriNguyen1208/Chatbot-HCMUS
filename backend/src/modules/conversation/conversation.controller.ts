...
import type { CreateConversationDto, GetConversationParamDto, AddMembersDto, RemoveMemberDto, AssignAdminDto, GetListQueryDto, UpdateConversationDto } from "./conversation.dto.js";
...
export class ConversationController {
    ...
    getList = async (req: Request, res: Response) => {
        ...
        if (search) {
            ...
            const searchResults = await searchFacade.searchConversations(search, userId);
