...
export const authApi = {
    ...
    microsoftLogin: async (idToken: string): Promise<Pick<UserProfile, "id" | "name" | "email">> => {
        const res = await api.post<ApiResponse<Pick<UserProfile, "id" | "name" | "email">>>(`/auth/microsoft`, { idToken });
        return res.data.data;
    },
